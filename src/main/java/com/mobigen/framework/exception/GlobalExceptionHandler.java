...
public class GlobalExceptionHandler {
    ...
    @ResponseBody
    public JsonResult clientErrorExceptionHandler(ClientErrorException e) {
    ...
    @ResponseBody
    public JsonResult responseStatusExceptionHandler(ResponseStatusException e) {
    ...
    @ResponseBody
    public JsonResult serverErrorExceptionHandler(ServerErrorException e) {
        log.error("ServerErrorException", e);
        return getExceptionJsonResult(e);
    }
    ...
    private String getMessage(Object e) throws Exception {
        ...
        if (e instanceof FieldError) {
            ...
            msg = message.get(((IOException) e).getClass().getName());
        } else if (e instanceof JsonResultException) {
    ...
    private JsonResult getExceptionJsonResult(Object error) {
        ...
        try {
            ...
            if (msg == null || "".equals(msg)) {
                ...
                if(msg != null && msg.equals("424 FAILED_DEPENDENCY")){
                    msg = message.get("com.mobigen.framework.exception.GlobalExceptionHandler.dependency");
                }
            }
        } catch (Exception e) {
            msg = message.get("com.mobigen.framework.exception.GlobalExceptionHandler");
